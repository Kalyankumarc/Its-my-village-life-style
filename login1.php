...
<body>
	<div class="content">
		<div class="header_bg">
			<div class ="header">
				...
				<span style="font-size:25px;padding:10px 0px 10px 90px;">KKV VILLAGE</span><span style="font-size:20px;padding:10px 0px 10px 800px;"><a href="#"style="color:yellow;">LOGOUT</a></span>
			</div>
		</div>
		<div class="marquee">
    ...
    <div id="main-wrapper">
					...
					<form class="myform"action="process.php" method="POST">
						...
						<input name="user" type="text" class="inputvalues" placeholder="Type your Username" required/></br>
						<label><b>Password:</b></label>
						<input name="pass" type="password" class="inputvalues" placeholder="Type your Password" required/></br>
